...
import { generateComponentCode, detectFramework } from '../../src/compiler/features/framework-codegen.js';
...
describe('Component Generator', () => {
  ...
  describe('generateComponentCode', () => {
    it('should generate React component', () => {
      ...
      expect(code).toContain('"btn-primary"'); // was '"Button"' - selector is btn-primary
    ...
    it('should generate Solid component', () => {
      ...
      expect(code).toContain('Dynamic'); // was splitProps - now uses <Dynamic> for tag support
    ...
    it('should strip leading dot from selector', () => {
      ...
      expect(code).toContain('"my-btn"'); // was '"Button"' - should check stripped selector
      expect(code).not.toContain('".my-btn"'); // should not contain dot version
    });
