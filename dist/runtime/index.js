...
var defaultTokens, DesignTokens, tokens;
...
var animationPresets, DEFAULT_ANIMATION_CONFIG;
...
var currentTokenContext2, debugMode, PUBLIC_METHODS, ChainClass;
var init_Chain = __esm({
  "src/compiler/Chain.ts"() {
    ...
    init_helpers();
    init_source();
    currentTokenContext2 = null;
    debugMode = false;
    PUBLIC_METHODS = /* @__PURE__ */ new Set([
      // Finalizers
      "$el",
      "end",
      // State & Nesting
...
var TOKEN_V2_KEY, StyleInjector, styleInjector, setTokens, compileRuntime, removeRuntimeModule;
var init_injector = __esm({
  "src/runtime/injector.ts"() {
    "use strict";
    init_common_utils();
    TOKEN_V2_KEY = "__CHAINCSS_V2_TOKENS__";
    StyleInjector = class {
      styleElement = null;
...
`;
    ...
    setTokens = (t) => styleInjector.setTokens(t);
    compileRuntime = (s, moduleId) => styleInjector.injectMultiple(s, moduleId);
    removeRuntimeModule = (moduleId) => styleInjector.removeModule(moduleId);
  }
});
...
__export(vue_exports, {
  ChainCSSGlobal: () => ChainCSSGlobal2,
  createStyledComponent: () => createStyledComponent2,
  createStyledComponents: () => createStyledComponents,
  disableVueDebug: () => disableVueDebug,
  enableVueDebug: () => enableVueDebug,
  injectStyleContext: () => injectStyleContext,
  isVueDebugEnabled: () => isVueDebugEnabled,
  provideStyleContext: () => provideStyleContext,
  useAtomicClasses: () => useAtomicClasses,
  useComputedStyles: () => useComputedStyles2
});
...
function enableVueDebug() {
  if (typeof window !== "undefined") {
    window.__CHAINCSS_VUE_DEBUG__ = true;
    console.log("\u{1F50D} ChainCSS Vue Debug Mode Enabled");
  }
}
function disableVueDebug() {
  if (typeof window !== "undefined") {
    window.__CHAINCSS_VUE_DEBUG__ = false;
    console.log("\u{1F50D} ChainCSS Vue Debug Mode Disabled");
  }
}
function isVueDebugEnabled() {
  return typeof window !== "undefined" && !!window.__CHAINCSS_VUE_DEBUG__;
}
var CHAIN_CSS_KEY, ChainCSSGlobal2;
var init_vue = __esm({
  "src/runtime/vue.ts"() {
    "use strict";
    init_injector();
    CHAIN_CSS_KEY = /* @__PURE__ */ Symbol("chaincss");
    ChainCSSGlobal2 = {
      name: "ChainCSSGlobal",
      props: {
        styles: {
...
// src/runtime/index.ts
var _lazyVue = () => Promise.resolve().then(() => (init_vue(), vue_exports));
var useAtomicClassesVue = (...args) => _lazyVue().then((m) => m.useAtomicClasses(...args));
var ChainCSSGlobalVue = (props) => {
  _lazyVue();
  return null;
};
var createStyledVueComponent = (...args) => (...a) => {
  _lazyVue();
  return null;
};
var createStyledVueComponents = (...args) => {
  _lazyVue();
  return {};
};
var useComputedStylesVue = (...args) => {
  _lazyVue();
  return {};
};
var provideStyleContext3 = (...args) => {
  _lazyVue();
};
var injectStyleContext3 = (...args) => {
  _lazyVue();
  return {};
};
...
export {
  ...
  hashString,
  injectChainStyles,
  injectStyleContext3 as injectStyleContext,
  ...
  logError,
  memoize,
  provideStyleContext3 as provideStyleContext,
