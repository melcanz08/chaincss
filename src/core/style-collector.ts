...
import type { ChainProxy, StyleObject as _StyleObject, AtRule as _AtRule, NestedRule as _NestedRule } from './types.js';
...
export class StyleCollector {
  ...
  filter(options: import('./shorthand-types.js').FilterOptions | string): this {
  ...
  shadow(options: import('./shorthand-types.js').ShadowOptions | string): this {
