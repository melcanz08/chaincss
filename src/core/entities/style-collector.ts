...
export class StyleCollector {
    ...
    if (typeof value === "object" && value !== null && !Array.isArray(value)) {
      ...
      if (isResponsive) {
        ...
        if ("base" in value) {
          ...
          this.debugger.log(
            prop,
            { realProp: prop, value: value.base, classification: "static" },
            value.base,
            "root",
          );
        }
  ...
  private getDisplay(): string | undefined {
    return (
      (this.props as any).get?.("display") ??
      (this.props as any).properties?.["display"]
    );
  }

  grid(
    options?: import("@shared/types/shorthand-types.js").GridOptions | string,
  ): this {
    ...
    if (typeof options === "object") {
      ...
      if (options.columns)
        this.set("gridTemplateColumns", options.columns as any);
      ...
      if (options.gap !== undefined) this.set("gap", options.gap as any);
        ...
        if (options.columnGap !== undefined)
          this.set("columnGap", options.columnGap as any);
        if (options.rowGap !== undefined)
          this.set("rowGap", options.rowGap as any);
      }
      ...
      if (options.autoColumns !== undefined)
        this.set("gridAutoColumns", options.autoColumns as any);
      if (options.autoRows !== undefined)
        this.set("gridAutoRows", options.autoRows as any);
      if (options.template) this.set("gridTemplate", options.template as any);
      if (options.c && !options.columns)
        this.set("gridTemplateColumns", options.c as any);
      if (options.r && !options.rows)
        this.set("gridTemplateRows", options.r as any);
      if (options.g !== undefined && options.gap === undefined)
        this.set("gap", options.g as any);
  ...
  flex(
    options?: import("@shared/types/shorthand-types.js").FlexOptions | string,
  ): this {
    ...
    if (typeof options === "object") {
      ...
      if (options.direction)
        this.set("flexDirection", options.direction as any);
      ...
      if (options.shrink !== undefined)
        this.set("flexShrink", options.shrink as any);
      if (options.basis !== undefined)
        this.set("flexBasis", options.basis as any);
  ...
  animation(
    options: import("@shared/types/shorthand-types.js").AnimationOptions,
  ): this {
    if (options.name) this.set("animationName", options.name as any);
    if (options.duration)
      this.set("animationDuration", options.duration as any);
    if (options.timing)
      this.set("animationTimingFunction", options.timing as any);
    if (options.delay) this.set("animationDelay", options.delay as any);
    if (options.iterationCount !== undefined)
      this.set("animationIterationCount", options.iterationCount as any);
    if (options.direction)
      this.set("animationDirection", options.direction as any);
    if (options.fillMode)
      this.set("animationFillMode", options.fillMode as any);
    if (options.playState)
      this.set("animationPlayState", options.playState as any);
    if (options.n && !options.name) this.set("animationName", options.n as any);
    if (options.d && !options.duration)
      this.set("animationDuration", options.d as any);
    if (options.t && !options.timing)
      this.set("animationTimingFunction", options.t as any);
    if (options.dl && !options.delay)
      this.set("animationDelay", options.dl as any);
    if (options.i !== undefined && options.iterationCount === undefined)
      this.set("animationIterationCount", options.i as any);
  ...
  background(
    options?:
      import("@shared/types/shorthand-types.js").BackgroundOptions | string,
  ): this {
    ...
    if (typeof options === "object") {
      ...
      if (options.position)
        this.set("backgroundPosition", options.position as any);
      ...
      if (options.attachment)
        this.set("backgroundAttachment", options.attachment as any);
      ...
      if (options.blendMode)
        this.set("backgroundBlendMode", options.blendMode as any);
      if (options.c && !options.color)
        this.set("backgroundColor", options.c as any);
      if (options.i && !options.image)
        this.set("backgroundImage", options.i as any);
      if (options.p && !options.position)
        this.set("backgroundPosition", options.p as any);
      if (options.s && !options.size)
        this.set("backgroundSize", options.s as any);
      if (options.r && !options.repeat)
        this.set("backgroundRepeat", options.r as any);
  ...
  typography(
    options: import("@shared/types/shorthand-types.js").TypographyOptions,
  ): this {
    if (options.fontFamily) this.set("fontFamily", options.fontFamily as any);
    if (options.fontSize !== undefined)
      this.set("fontSize", options.fontSize as any);
    if (options.fontWeight !== undefined)
      this.set("fontWeight", options.fontWeight as any);
    if (options.fontStyle) this.set("fontStyle", options.fontStyle as any);
    if (options.lineHeight !== undefined)
      this.set("lineHeight", options.lineHeight as any);
    if (options.letterSpacing !== undefined)
      this.set("letterSpacing", options.letterSpacing as any);
    if (options.textAlign) this.set("textAlign", options.textAlign as any);
    if (options.textTransform)
      this.set("textTransform", options.textTransform as any);
    if (options.textDecoration)
      this.set("textDecoration", options.textDecoration as any);
    if (options.textIndent !== undefined)
      this.set("textIndent", options.textIndent as any);
    if (options.wordSpacing !== undefined)
      this.set("wordSpacing", options.wordSpacing as any);
    ...
    if (options.opacity !== undefined)
      this.set("opacity", options.opacity as any);
    if (options.ff && !options.fontFamily)
      this.set("fontFamily", options.ff as any);
    if (options.fs !== undefined && options.fontSize === undefined)
      this.set("fontSize", options.fs as any);
    if (options.fw !== undefined && options.fontWeight === undefined)
      this.set("fontWeight", options.fw as any);
    if (options.lh !== undefined && options.lineHeight === undefined)
      this.set("lineHeight", options.lh as any);
    if (options.ta && !options.textAlign)
      this.set("textAlign", options.ta as any);
    if (options.tt && !options.textTransform)
      this.set("textTransform", options.tt as any);
  ...
  box(options: import("@shared/types/shorthand-types.js").BoxOptions): this {
    ...
    if (options.marginTop !== undefined)
      this.set("marginTop", options.marginTop as any);
    if (options.marginRight !== undefined)
      this.set("marginRight", options.marginRight as any);
    if (options.marginBottom !== undefined)
      this.set("marginBottom", options.marginBottom as any);
    if (options.marginLeft !== undefined)
      this.set("marginLeft", options.marginLeft as any);
    if (options.padding !== undefined)
      this.set("padding", options.padding as any);
    if (options.paddingTop !== undefined)
      this.set("paddingTop", options.paddingTop as any);
    if (options.paddingRight !== undefined)
      this.set("paddingRight", options.paddingRight as any);
    if (options.paddingBottom !== undefined)
      this.set("paddingBottom", options.paddingBottom as any);
    if (options.paddingLeft !== undefined)
      this.set("paddingLeft", options.paddingLeft as any);
    if (options.border) this.set("border", options.border as any);
    if (options.borderRadius !== undefined)
      this.set("borderRadius", options.borderRadius as any);
    if (options.borderWidth !== undefined)
      this.set("borderWidth", options.borderWidth as any);
    if (options.borderColor)
      this.set("borderColor", options.borderColor as any);
    if (options.borderStyle)
      this.set("borderStyle", options.borderStyle as any);
    if (options.borderTop) this.set("borderTop", options.borderTop as any);
    if (options.borderRight)
      this.set("borderRight", options.borderRight as any);
    if (options.borderBottom)
      this.set("borderBottom", options.borderBottom as any);
    ...
    if (options.minWidth !== undefined)
      this.set("minWidth", options.minWidth as any);
    if (options.maxWidth !== undefined)
      this.set("maxWidth", options.maxWidth as any);
    if (options.height !== undefined) this.set("height", options.height as any);
    if (options.minHeight !== undefined)
      this.set("minHeight", options.minHeight as any);
    if (options.maxHeight !== undefined)
      this.set("maxHeight", options.maxHeight as any);
    ...
    if (options.m !== undefined && options.margin === undefined)
      this.set("margin", options.m as any);
    if (options.p !== undefined && options.padding === undefined)
      this.set("padding", options.p as any);
    if (options.br !== undefined && options.borderRadius === undefined)
      this.set("borderRadius", options.br as any);
    if (options.w !== undefined && options.width === undefined)
      this.set("width", options.w as any);
    if (options.h !== undefined && options.height === undefined)
      this.set("height", options.h as any);
    return this;
  }

  position(
    options: import("@shared/types/shorthand-types.js").PositionOptions,
  ): this {
    ...
    if (options.z !== undefined && options.zIndex === undefined)
      this.set("zIndex", options.z as any);
    return this;
  }

  transition(
    options?:
      import("@shared/types/shorthand-types.js").TransitionOptions | string,
  ): this {
    if (options === undefined) return this;
    if (typeof options === "string") return this.set("transition", options);
    if (typeof options === "object") {
      if (options.property)
        this.set("transitionProperty", options.property as any);
      if (options.duration)
        this.set("transitionDuration", options.duration as any);
      if (options.timing)
        this.set("transitionTimingFunction", options.timing as any);
      if (options.delay) this.set("transitionDelay", options.delay as any);
      if (options.behavior)
        this.set("transitionBehavior", options.behavior as any);
      if (options.p && !options.property)
        this.set("transitionProperty", options.p as any);
      if (options.d && !options.duration)
        this.set("transitionDuration", options.d as any);
      if (options.t && !options.timing)
        this.set("transitionTimingFunction", options.t as any);
  ...
  transform(
    options?:
      import("@shared/types/shorthand-types.js").TransformOptions | string,
  ): this {
    ...
    if (typeof options === "object") {
      ...
      if (options.translateX !== undefined)
        parts.push(`translateX(${px(options.translateX)})`);
      if (options.translateY !== undefined)
        parts.push(`translateY(${px(options.translateY)})`);
      if (options.translateZ !== undefined)
        parts.push(`translateZ(${px(options.translateZ)})`);
  ...
  filter(
    options: import("@shared/types/shorthand-types.js").FilterOptions | string,
  ): this {
    ...
    if (options.filterOpacity !== undefined)
      parts.push(`opacity(${options.filterOpacity})`);
    if (options.saturate !== undefined)
      parts.push(`saturate(${options.saturate})`);
  ...
  shadow(
    options: import("@shared/types/shorthand-types.js").ShadowOptions | string,
  ): this {
    ...
    if (options.box) this.set("boxShadow", options.box as any);
      ...
      const spread =
        options.spread !== undefined ? ` ${px(options.spread)}` : "";
  ...
  containerQuery(
    options: import("@shared/types/shorthand-types.js").ContainerOptions,
  ): this {
  ...
  outline(
    options: import("@shared/types/shorthand-types.js").OutlineOptions,
  ): this {
    if (options.width !== undefined)
      this.set("outlineWidth", options.width as any);
    ...
    if (options.offset !== undefined)
      this.set("outlineOffset", options.offset as any);
    if (options.w !== undefined && options.width === undefined)
      this.set("outlineWidth", options.w as any);
  ...
  scroll(
    options: import("@shared/types/shorthand-types.js").ScrollOptions,
  ): this {
    ...
    if (options.snapAlign)
      this.set("scrollSnapAlign", options.snapAlign as any);
    if (options.snapStop) this.set("scrollSnapStop", options.snapStop as any);
    if (options.margin !== undefined)
      this.set("scrollMargin", options.margin as any);
    if (options.marginTop !== undefined)
      this.set("scrollMarginTop", options.marginTop as any);
    if (options.marginRight !== undefined)
      this.set("scrollMarginRight", options.marginRight as any);
    if (options.marginBottom !== undefined)
      this.set("scrollMarginBottom", options.marginBottom as any);
    if (options.marginLeft !== undefined)
      this.set("scrollMarginLeft", options.marginLeft as any);
    if (options.padding !== undefined)
      this.set("scrollPadding", options.padding as any);
    if (options.paddingTop !== undefined)
      this.set("scrollPaddingTop", options.paddingTop as any);
    if (options.paddingRight !== undefined)
      this.set("scrollPaddingRight", options.paddingRight as any);
    if (options.paddingBottom !== undefined)
      this.set("scrollPaddingBottom", options.paddingBottom as any);
    if (options.paddingLeft !== undefined)
      this.set("scrollPaddingLeft", options.paddingLeft as any);
    if (options.scrollbarWidth)
      this.set("scrollbarWidth", options.scrollbarWidth as any);
    if (options.scrollbarColor)
      this.set("scrollbarColor", options.scrollbarColor as any);
    if (options.overflowX) this.set("overflowX", options.overflowX as any);
    if (options.overflowY) this.set("overflowY", options.overflowY as any);
    if (options.b && !options.behavior)
      this.set("scrollBehavior", options.b as any);
    return this;
  }
  ...
  list(options: import("@shared/types/shorthand-types.js").ListOptions): this {
    ...
    if (options.position)
      this.set("listStylePosition", options.position as any);
  ...
  disabled(fn?: (c: ChainProxy) => void): this {
    return fn
      ? this.pseudoWithCallback("disabled", fn)
      : this.pseudo("disabled");
  }
  ...
  placeholder(fn?: (c: ChainProxy) => void): this {
    return fn
      ? this.pseudoWithCallback(":placeholder", fn)
      : this.pseudo(":placeholder");
  }
  ...
  when(condition: boolean, fn: (c: ChainProxy) => void): this {
    ...
    if (child._atRules?.length) {
      for (const r of child._atRules) {
        if (r.type === "media")
          this.rules.addMedia(r.query || "", r.styles || {});
        else if (r.type === "supports")
          this.rules.addSupports(r.condition || "", r.styles || {});
        else if (r.type === "container")
          this.rules.addContainer(r.condition || "", r.styles || {});
        else if (r.type === "layer")
          this.rules.addLayer(r.name || "", r.styles || {});
        else if (r.type === "keyframes")
          this.rules.addKeyframes(r.name || "", r.steps || {});
        else if (r.type === "font-face")
          this.rules.addFontFace(r.properties || {});
      }
    }
    ...
    if (styleDef && typeof styleDef === "object") {
      ...
      if ((styleDef as any)._atRules) {
        for (const rule of (styleDef as any)._atRules) {
          this.rules.addMedia(
            rule.query || rule.condition || rule.name,
            rule.styles || {},
          );
        }
      }
  ...
  build(selectors?: string[] | string): StyleObject & { selectors?: string[] } {
    ...
    const atRules = [
      ...this.rules.getAtRules(),
      ...extraAt,
      ...extraAtUnderscore,
    ];
    const nestedRules = [
      ...this.rules.getNestedRules(),
      ...extraNested,
      ...extraNestedUnderscore,
    ];
