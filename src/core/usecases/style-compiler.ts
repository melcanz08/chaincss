...
import type { StyleObject, CSSProperties, PseudoStyles, AtRule, NestedRule, CSSPrimitiveValue } from '@shared/types/index.js';
import { parseStyleObject, isCSSPrimitiveValue, isDynamicValue } from '@shared/types/index.js';
