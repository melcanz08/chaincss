...
export interface ChainCSSConfig {
  ...
  output?: {
    ...
    typesFile?: string;
    minify?: boolean;
    generateGlobalCSS?: boolean;  // ← Add this line
  };
  timeline?: boolean;  // Enable style timeline tracking
  sourceComments?: boolean;  // Enable/disable source comments in CSS
  debug?: boolean;  // Global debug mode
  breakpoints?: Record<string, string>;  // Custom Responsive Breakpoints
  namespace?: string;
  verbose?: boolean;
}