...
/**
 * Get or create a logger instance (alias for createLogger)
 * @deprecated Use createLogger instead
 */
export function getLogger(verbose: boolean = false, scope: string = 'global'): Logger {
  return createLogger(verbose, scope);
}
