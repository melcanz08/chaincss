...
export const helpers = {
  ...
  toRem: (v: any, base = 16) =>
    toStr((math as any).toRem(v, { rootFontSize: base })),
  toEm: (v: any, base = 16) =>
    toStr((math as any).toEm(v, { parentFontSize: base })),

  // smart css
  clamp: (min: any, pref: any, max: any) =>
    toStr((math as any).clampValue(pref, min, max)),
